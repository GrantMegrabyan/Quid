...
CATEGORY_SEEDS: tuple[_CatSeed, ...] = (
    _CatSeed("cat-groceries", "Groceries", "shopping-cart"),
    _CatSeed("cat-transport", "Transport", "train-front"),
    _CatSeed("cat-housing", "Housing", "house"),
    _CatSeed("cat-dining", "Dining Out", "utensils"),
    _CatSeed("cat-bills", "Bills", "receipt"),
)

EXPENSE_SEEDS: tuple[_ExpSeed, ...] = (
    _ExpSeed("exp-001", "Whole Foods", "58.24", "cat-groceries", "Weekly groceries", 0, 3),
    _ExpSeed("exp-002", "Transport for London", "14.50", "cat-transport", "Bus fare", 0, 7),
    _ExpSeed("exp-003", "Starbucks", "42.80", "cat-dining", "Coffee and lunch", 1, 11),
    _ExpSeed("exp-004", "Greystar Rent", "1200.00", "cat-housing", "", 1, 1),
    _ExpSeed("exp-005", "Comcast Xfinity", "96.12", "cat-bills", "Internet bill", 2, 5),
    _ExpSeed("exp-006", "Trader Joes", "33.75", "cat-groceries", "Pantry restock", 2, 13),
    _ExpSeed("exp-007", "Uber", "22.00", "cat-transport", "Rideshare", 3, 9),
    _ExpSeed("exp-008", "Deliveroo", "68.40", "cat-dining", "Dinner out", 3, 19),
    _ExpSeed("exp-009", "Sainsbury's", "48.90", "cat-groceries", "Farmers market", 4, 6),
    _ExpSeed("exp-010", "Pacific Gas & Electric", "74.30", "cat-bills", "Electricity", 4, 16),
    _ExpSeed("exp-011", "NCP Parking", "15.20", "cat-transport", "Parking", 5, 4),
    _ExpSeed("exp-012", "Chipotle", "89.95", "cat-dining", "Team lunch", 5, 10),
    _ExpSeed("exp-013", "Amazon Prime", "27.60", "cat-groceries", "Snacks", 0, 21),
    _ExpSeed("exp-014", "Thames Water", "110.40", "cat-bills", "Water bill", 2, 24),
    ...
    _ExpSeed("exp-017", "Netflix", "17.99", "cat-bills", "Streaming", 0, 18),
)
