...
type ExpenseSeed = {
	id: `exp-${string}`;
	name: string;
	/** Canonical 2dp money string ("58.24"), matching the API contract. */
	amount: string;
	categoryId: string;
	note: string;
...
const EXPENSE_SEEDS: readonly ExpenseSeed[] = [
	...
	{ id: 'exp-002', name: 'Transport for London', amount: '14.50', categoryId: 'cat-public-transport', note: 'Bus fare', monthsAgo: 0, day: 7 },
	{ id: 'exp-003', name: 'Starbucks', amount: '42.80', categoryId: 'cat-eating-out', note: 'Coffee and lunch', monthsAgo: 1, day: 11 },
	{ id: 'exp-004', name: 'Greystar Rent', amount: '1200.00', categoryId: 'cat-housing', note: '', monthsAgo: 1, day: 1 },
	...
	{ id: 'exp-007', name: 'Uber', amount: '22.00', categoryId: 'cat-taxi', note: 'Rideshare', monthsAgo: 3, day: 9 },
	{ id: 'exp-008', name: 'Deliveroo', amount: '68.40', categoryId: 'cat-eating-out', note: 'Dinner out', monthsAgo: 3, day: 19 },
	{ id: 'exp-009', name: 'Sainsbury’s', amount: '48.90', categoryId: 'cat-groceries', note: 'Farmers market', monthsAgo: 4, day: 6 },
	{ id: 'exp-010', name: 'Pacific Gas & Electric', amount: '74.30', categoryId: 'cat-housing', note: 'Electricity', monthsAgo: 4, day: 16 },
	{ id: 'exp-011', name: 'NCP Parking', amount: '15.20', categoryId: 'cat-car', note: 'Parking', monthsAgo: 5, day: 4 },
